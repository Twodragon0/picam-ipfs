...
picDir = "/media/pi/331C-F4E91/PiCam2/data/" # where to save extracted JPEG still frames
logFileName = "/media/pi/331C-F4E91/PiCam2/data/eLog.csv" # event log file to append to
